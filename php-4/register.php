...
<?php 
    ...
    if(isset($_POST['register'])){
        ...
        // strtolower() Mengubah menjadi huruh kecil semua, preg_replace() menghilangkan karakter yang kecuali ditulis
        ...
        if($password == $konfirmasi){
            ...
            if(!$data){
                $query = mysqli_query($db, "INSERT INTO user (username, password, id_role) VALUES ('$username','$password', 2)");
...
<!-- Form -->
<div class="container p-3 mt-3 bg-light border border-2">
<h2 class="mt-3">Silahkan Daftar</h2>
    <form method="POST">
        <div class="mb-3">
    ...
    <button type="submit" class="btn border btn-primary" name="register">Register</button>
